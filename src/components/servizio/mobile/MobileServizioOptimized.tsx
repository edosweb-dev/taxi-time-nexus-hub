...
import { MapPin, User, Clock, Building2, Car } from "lucide-react";
...
export function MobileServizioOptimized({
  ...
  return (
    <div className="space-y-4 px-4 py-6 pb-24">
      {/* Header compatto con info essenziali */}
      <div className="space-y-3 pb-4 border-b">
        ...
        <div className="space-y-2 text-sm">
          ...
          {servizio.referente_id && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-xs text-muted-foreground">Referente: </span>
          ...
          {veicoloModello && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-xs text-muted-foreground">Veicolo: </span>
                <span className="font-medium">{veicoloModello}</span>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex gap-2 pt-2">
          ...
          {servizio.stato === "da_assegnare" && isAdmin && (
            <Button onClick={onAssegna} size="sm" variant="outline" className="flex-1">
        ...
        <CardContent>
          <div className="space-y-3 text-sm">
            ...
            <div>
              ...
              <div className="font-semibold text-lg">{formatCurrency(servizio.incasso_ricevuto)}</div>
            </div>

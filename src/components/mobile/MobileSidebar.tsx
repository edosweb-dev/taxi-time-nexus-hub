  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        { icon: FileText, label: 'Nuovo Servizio', path: '/dashboard-cliente/nuovo-servizio', roles: ['cliente'] },
        { icon: Users, label: 'Passeggeri', path: '/dashboard-cliente/passeggeri', roles: ['cliente'] },

...
export function VeicoliFilters({
  ...
  return (
    <div className="space-y-4 md:hidden">
      ...
      {/* Posti Filters */}
      <div>
        <Label className="text-sm font-medium mb-2 block">Capacità</Label>
        <div className="flex gap-2 flex-wrap">
...
function FilterChip({ children, active, onClick, count, disabled }: FilterChipProps) {
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "inline-flex items-center gap-1.5 px-3 py-2 rounded-full text-sm border transition-all min-h-[44px]",
        active 

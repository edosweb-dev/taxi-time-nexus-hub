  ...
  return (
    <Card className="w-full shadow-none border-0 bg-transparent">
      <CardHeader className="pb-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">Accedi a Taxitime</h1>
        <p className="text-sm text-center text-gray-600 mt-2">Inserisci le tue credenziali per continuare</p>
      </CardHeader>
      ...
      <form onSubmit={handleLogin}>
        ...
        <CardFooter className="flex flex-col gap-6 pb-2">
          <Button 
            type="submit" 

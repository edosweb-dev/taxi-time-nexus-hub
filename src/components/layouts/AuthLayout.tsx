...
export function AuthLayout({ children }: PropsWithChildren) {
  return (
    <div className="auth-page min-h-screen min-h-[100dvh] w-full bg-gradient-to-br from-background via-background/95 to-primary/5 flex items-center justify-center overflow-hidden relative px-4 py-2">
      {/* Background patterns */}
        ...
        <div className="animate-fade-in">
          <div className="space-y-3">
            ...
            <div className="text-center">
              <div className="mb-1">
                <img
                  src="/uploads/f9301fdf-4c2b-4c27-938e-04f6b32870f2.png"
                  alt="Taxitime Logo" 

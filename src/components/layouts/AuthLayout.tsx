...
export function AuthLayout({ children }: PropsWithChildren) {
  return (
    <div className="login-centered min-h-screen min-h-[100dvh] w-full bg-gradient-to-br from-background via-background to-muted/10 flex items-center justify-center px-5 py-8 sm:px-6 lg:px-8 overflow-hidden">

...
import { ChevronLeft, ChevronRight, ArrowLeft, Clock, MapPin, Building2, User } from 'lucide-react';
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Vista calendario giornaliera - {dayServizi.length} servizi
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border min-h-[700px]">
            ...
            <div className="grid h-full" style={{ gridTemplateColumns: `repeat(${Object.keys(serviziByAssignee).length}, 1fr)` }}>
              ...
              <div className="contents">
                {Object.keys(serviziByAssignee).map(assigneeId => (
                  <div key={`header-${assigneeId}`} className="border-b border-r p-4 bg-gray-50/50">
                  ...
                  <div key={`content-${assigneeId}`} className="border-r p-4 space-y-3 min-h-[600px]">
                    {serviziByAssignee[assigneeId]
                      ...
                      .map(servizio => (
                        <Card 
                          key={servizio.id} 
                          className="p-3 cursor-pointer hover:shadow-md transition-all duration-200 border-l-4 hover:scale-[1.02]"
                          style={{ 
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                              <div className="flex items-start gap-2 text-sm">
                                ...
                                <div>
                                  <div className="font-medium text-green-700">Partenza</div>
                              ...
                              <div className="flex items-start gap-2 text-sm">
                                ...
                                <div>
                                  <div className="font-medium text-red-700">Destinazione</div>
                                  <div className="text-xs text-muted-foreground line-clamp-2">
                            ...
                            {/* Notes */}
                            {servizio.note && (
                              <div className="text-xs text-muted-foreground bg-white/70 px-2 py-1 rounded italic">

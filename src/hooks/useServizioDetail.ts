    ...
    queryFn: async () => {
      ...
      const passeggeriData = (servizioData.servizi_passeggeri || []).map((sp: any) => {
        ...
        return {
          ...
          localita_presa_personalizzato: sp.localita_presa_personalizzato || null,
          destinazione_personalizzato: sp.destinazione_personalizzato || null,
          localita_destinazione_personalizzato: sp.localita_destinazione_personalizzato || null,
          usa_indirizzo_personalizzato: sp.usa_indirizzo_personalizzato ?? false,
          usa_destinazione_personalizzata: sp.usa_destinazione_personalizzata ?? false,
          ordine_presa: sp.ordine_presa ?? 0,
